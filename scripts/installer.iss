...
OutputBaseFilename=VideoInstaller-Setup
Compression=lzma
...
[Files]
Source: "{#MySourceRoot}\release\VideoInstaller-win-x64\VideoInstaller.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#MySourceRoot}\release\VideoInstaller-win-x64\release-manifest.json"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#MySourceRoot}\release\VideoInstaller-win-x64\static\*"; DestDir: "{app}\static"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#MySourceRoot}\release\VideoInstaller-win-x64\tools\*"; DestDir: "{app}\tools"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  begin
    ConfigText := '{'#13#10 +
      ...
      '  "disable": false,'#13#10 +
      '  "proxy": "http://127.0.0.1:7890",'#13#10 +
